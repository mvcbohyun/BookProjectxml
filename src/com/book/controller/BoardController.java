...
public class BoardController {
	...
	public String main(@RequestParam("info_idx") int info_idx,
		...
		String InfoName = boardService.getInfoName(info_idx);
		
		model.addAttribute("InfoName",InfoName);
		
		List<ContentBean> contentList = boardService.getContentList(info_idx,page);
	...
	public String write(@ModelAttribute("writeContentBean") ContentBean writeContentBean,
						@RequestParam("content_board_idx") int content_board_idx ) {
	...
	public String modify(@RequestParam("info_idx") int info_idx,
		...
		modifyContentBean.setAddDate(tempContentBean.getAddDate());
		...
		modifyContentBean.setContent_board_idx(info_idx);
	...
	public String commentdelete(@RequestParam("code") int info_idx){
